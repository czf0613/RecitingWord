...
public class CET4EntityDao extends AbstractDao<CET4Entity, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, CET4Entity entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CET4Entity entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(CET4Entity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(CET4Entity entity) {
