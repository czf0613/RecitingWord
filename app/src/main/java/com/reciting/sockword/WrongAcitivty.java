...
import com.reciting.adapter.CardFragmentPagerAdapter;
...
public class WrongAcitivty extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // DevOpenHelper类继承自SQLiteOpenHelper,第一个参数Context,第二个参数数据库名字,第三个参数CursorFactory
