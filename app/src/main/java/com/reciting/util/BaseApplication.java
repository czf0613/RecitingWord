...
public class BaseApplication extends Application
{
    ...
    private static Map<String, AppCompatActivity> destroyMap=new HashMap<>();
    ...
    public static void addDestoryActivity(AppCompatActivity activity, String activityName)
    {
